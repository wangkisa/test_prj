            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">쿠폰 코드 발행 페이지</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="/admin/publish_coupon" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="prefix 3자리 입력해주세요." name="prefix"  type="text" autofocus>
                                </div>
                                
                                <button type="submit" class="btn btn-lg btn-success btn-block">발행</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
